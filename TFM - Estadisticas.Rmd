...
datos_sent$hora_int[(datos_sent$hora<="18") & (datos_sent$hora>"12") ] <- "evening" 
datos_sent$hora_int[(datos_sent$hora<="24") & (datos_sent$hora>"18") ] <- "night"
datos_sent$hora_int[(datos_sent$hora<="06") & (datos_sent$hora>"00")] <- "late night"
