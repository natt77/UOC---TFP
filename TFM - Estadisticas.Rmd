...
#Observamos que hay valores que se han introducido como NA para las columnas numéricas, miramos que esta ocurriendo

which(is.na(datos$likes_count_fb))

#hay 2 filas que contienen NA, vemos el valor completo de la fila en el fichero original

fdatos[501,]
fdatos[1955,]


#En el primer caso es una linea de cabecera, en el segundo se han desplazado las columnas. Borramos las dos filas para poder seguir trabajando, solo en datos, no en fdatos
...
filtrado <- data.frame(subset(union_df_freq, freq>35))

p <- ggplot(filtrado, aes(word, freq, colour=factor(nivel)))    
