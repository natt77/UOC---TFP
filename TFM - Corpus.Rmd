...
#nube de palabras
wordcloud(palab_frec.df$word, palab_frec.df$freq, random.color=FALSE,random.order = FALSE, colors=colorRampPalette(brewer.pal(6,"Blues"))(32), max.words=150, rot.per=0)
...
wordcloud(palab_frec_dec.df$word, palab_frec_dec.df$freq, random.color=FALSE,random.order = FALSE, colors=colorRampPalette(brewer.pal(6,"Blues"))(32), max.words=150, rot.per=0)
